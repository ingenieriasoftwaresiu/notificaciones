 ...
 * @author jorge.correa
 */
public class NotificarInvitacionTEM {
    public static void main(String[] args){
        ...
        // message info        
        String subject = "Invitación al acto de inauguración del Laboratorio de Microscopia Electrónica de Transmisión - TEM";
        
        try{
            CsvReader usuarios_import = new CsvReader("C:\\WebApps\\Notificaciones\\Prueba.csv");
            ...
            while (usuarios_import.readRecord()){
                ...
                body.append("Por medio del presente mensaje queremos hacerle extensiva la siguiente invitación:<br /><br />");
                body.append("<div align='center'>");
                body.append("<img src=\"cid:image1\" width=\"70%\" height=\"70%\" /><br>");
                body.append("</div>");
                body.append("<br />");
                ...
                // inline images                
                inlineImages.put("image1", "C:/WebApps/Notificaciones/notificaciones/web/Images/Invitacion.jpg");
